...
static void v_wayv_process_midi_event(
    t_wayv *plugin_data, t_seq_event * a_event, int f_poly_mode)
{
...
{
    PYFX_Descriptor *f_result = get_pyfx_descriptor(WAYV_COUNT);

    set_pyfx_port(f_result, WAYV_ATTACK_MAIN, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY_MAIN, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN_MAIN, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE_MAIN, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ATTACK1, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY1, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN1, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE1, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ATTACK2, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY2, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN2, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE2, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_NOISE_AMP, -30.0f, -60.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC1_TYPE, 1.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC1_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC1_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC1_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC2_TYPE, 0.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC2_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC2_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC2_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_MASTER_VOLUME, -6.0f, -30.0f, 12.0f);
    set_pyfx_port(f_result, WAYV_OSC1_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC1_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_MASTER_GLIDE, 0.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_MASTER_PITCHBEND_AMT, 18.0f, 1.0f, 36.0f);
    set_pyfx_port(f_result, WAYV_ATTACK_PFX1, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY_PFX1, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN_PFX1, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE_PFX1, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ATTACK_PFX2, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY_PFX2, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN_PFX2, 100.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_RELEASE_PFX2, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_RAMP_ENV_TIME, 100.0f, 0.0f, 600.0f);
    set_pyfx_port(f_result, WAYV_LFO_FREQ, 200.0f, 10, 1600);
    set_pyfx_port(f_result, WAYV_LFO_TYPE, 0.0f, 0.0f, 2.0f);
    set_pyfx_port(f_result, WAYV_FX0_KNOB0, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX0_KNOB1, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX0_KNOB2, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX0_COMBOBOX, 0.0f, 0.0f, MULTIFX3KNOB_MAX_INDEX);
    set_pyfx_port(f_result, WAYV_FX1_KNOB0, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX1_KNOB1, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX1_KNOB2, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX1_COMBOBOX, 0.0f, 0.0f, MULTIFX3KNOB_MAX_INDEX);
    set_pyfx_port(f_result, WAYV_FX2_KNOB0, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX2_KNOB1, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX2_KNOB2, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX2_COMBOBOX, 0.0f, 0.0f, MULTIFX3KNOB_MAX_INDEX);
    set_pyfx_port(f_result, WAYV_FX3_KNOB0, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX3_KNOB1, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX3_KNOB2, 64.0f, 0.0f, 127.0f);
    set_pyfx_port(f_result, WAYV_FX3_COMBOBOX, 0.0f, 0.0f, MULTIFX3KNOB_MAX_INDEX);
    ...
    set_pyfx_port(f_result, WAYV_NOISE_TYPE, 0.0f, 0, 2);
    set_pyfx_port(f_result, WAYV_ADSR1_CHECKBOX, 0.0f, 0, 1);
    set_pyfx_port(f_result, WAYV_ADSR2_CHECKBOX, 0.0f, 0, 1);
    set_pyfx_port(f_result, WAYV_LFO_AMP, 0.0f, -24.0f, 24.0f);
    set_pyfx_port(f_result, WAYV_LFO_PITCH, 0.0f, -36.0f, 36.0f);
    set_pyfx_port(f_result, WAYV_PITCH_ENV_AMT, 0.0f, -60.0f, 60.0f);
    set_pyfx_port(f_result, WAYV_OSC2_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC2_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_LFO_AMOUNT, 100.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_TYPE, 0.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC3_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC3_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC3_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC3_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC1_FM1, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC1_FM2, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC1_FM3, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC2_FM1, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC2_FM2, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC2_FM3, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_FM1, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_FM2, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_FM3, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_ATTACK3, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY3, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN3, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE3, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR3_CHECKBOX, 0.0f, 0, 1);
    ...
    set_pyfx_port(f_result, WAYV_PERC_ENV_TIME1, 10.0f, 2.0f, 40.0f);
    set_pyfx_port(f_result, WAYV_PERC_ENV_PITCH1, 66.0f, 42.0f, 120.0f);
    set_pyfx_port(f_result, WAYV_PERC_ENV_TIME2, 100.0f, 20.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_PERC_ENV_PITCH2, 48.0f, 33.0f, 63.0f);
    set_pyfx_port(f_result, WAYV_PERC_ENV_ON, 0.0f, 0.0f, 1.0f);
    set_pyfx_port(f_result, WAYV_RAMP_CURVE, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_MONO_MODE, 0.0f, 0.0f, 3.0f);
    set_pyfx_port(f_result, WAYV_OSC1_FM4, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC2_FM4, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC3_FM4, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_TYPE, 0.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC4_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC4_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC4_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC4_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_FM1, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_FM2, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_FM3, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC4_FM4, 0.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_ATTACK4, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY4, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN4, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE4, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR4_CHECKBOX, 0.0f, 0, 1);
    set_pyfx_port(f_result, WAYV_LFO_PHASE, 0.0f, 0.0f, 100.0);
    ...
    set_pyfx_port(f_result, WAYV_LFO_PITCH_FINE, 0.0f, -100.0f, 100.0);
    set_pyfx_port(f_result, WAYV_ADSR_PREFX, 0.0f, 0.0f, 1.0);
    ...
    set_pyfx_port(f_result, WAYV_DELAY_NOISE, 0.0f, 0.0f, 200.0);
    set_pyfx_port(f_result, WAYV_ATTACK_NOISE, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_HOLD_NOISE, 0.0f, 0.0f, 200.0);
    set_pyfx_port(f_result, WAYV_DECAY_NOISE, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN_NOISE, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE_NOISE, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR_NOISE_ON, 0.0f, 0.0f, 1.0f);
    set_pyfx_port(f_result, WAYV_DELAY_LFO, 0.0f, 0.0f, 200.0);
    set_pyfx_port(f_result, WAYV_ATTACK_LFO, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_HOLD_LFO, 0.0f, 0.0f, 200.0);
    set_pyfx_port(f_result, WAYV_DECAY_LFO, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN_LFO, 100.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_RELEASE_LFO, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR_LFO_ON, 0.0f, 0.0f, 1.0f);
    set_pyfx_port(f_result, WAYV_OSC5_TYPE, 0.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC5_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC5_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC5_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC5_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC5_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_ADSR5_DELAY, 0.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_ATTACK5, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_ADSR5_HOLD, 0.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY5, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN5, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE5, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR5_CHECKBOX, 0.0f, 0, 1);
    set_pyfx_port(f_result, WAYV_OSC6_TYPE, 0.0f, 0.0f, (MKFLT)WT_TOTAL_WAVETABLE_COUNT);
    set_pyfx_port(f_result, WAYV_OSC6_PITCH, 0.0f, -72.0f, 72.0f);
    set_pyfx_port(f_result, WAYV_OSC6_TUNE, 0.0f, -100.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_OSC6_VOLUME, -6.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_OSC6_UNISON_VOICES, 1.0f, 1.0f, 7.0f);
    set_pyfx_port(f_result, WAYV_OSC6_UNISON_SPREAD, 50.0f, 0.0f, 100.0f);
    set_pyfx_port(f_result, WAYV_ADSR6_DELAY, 0.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_ATTACK6, 10.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_ADSR6_HOLD, 0.0f, 0.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_DECAY6, 50.0f, 10.0f, 200.0f);
    set_pyfx_port(f_result, WAYV_SUSTAIN6, 0.0f, -30.0f, 0.0f);
    set_pyfx_port(f_result, WAYV_RELEASE6, 50.0f, 10.0f, 400.0f);
    set_pyfx_port(f_result, WAYV_ADSR6_CHECKBOX, 0.0f, 0, 1);
    set_pyfx_port(f_result, WAYV_MIN_NOTE, 0.0f, 0.0f, 120.0f);
    set_pyfx_port(f_result, WAYV_MAX_NOTE, 120.0f, 0.0f, 120.0f);
    set_pyfx_port(f_result, WAYV_MASTER_PITCH, 0.0f, -36.0f, 36.0f);
    set_pyfx_port(f_result, WAYV_ADSR_LIN_MAIN, 1.0f, 0.0f, 1.0f);
    ...
    set_pyfx_port(f_result, WAYV_NOISE_PREFX, 1.0f, 0, 1);
