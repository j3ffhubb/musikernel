...
if "src/musikernel/python/" in __file__:
    INSTALL_PREFIX = "/usr"
else:
...
def load_engine_lib(a_engine_callback):
    ...
    f_dll_name = "{}{}".format(MAJOR_VERSION, DLL_EXT)
