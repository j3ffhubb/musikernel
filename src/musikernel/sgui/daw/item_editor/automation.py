...
#                        f_line.setPen(f_line_pen)
    ...
    def draw_point(self, a_cc, a_select=True):
        """ a_cc is an instance of the mk_project.cc class"""
...
class AutomationEditorWidget:
    ...
    def add_cc_point(self, a_value=None):
        ...
        def ok_handler():
            ...
            shared.PROJECT.commit(_("Add automation point"))
    ...
    def add_pb_point(self):
        ...
        def ok_handler():
            ...
            shared.PROJECT.save_item(shared.CURRENT_ITEM_NAME, shared.CURRENT_ITEM)
            global_open_items(shared.CURRENT_ITEM_NAME)
            shared.PROJECT.commit(_("Add pitchbend automation point"))
            self.automation_viewer.draw_item()
        ...
        f_layout.addWidget(QLabel(
            mk_strings.pitchbend_dialog), 30, 1)
