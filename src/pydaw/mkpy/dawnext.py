...
from .libdawnext.filedragdrop import FileDragDropper
from .libdawnext.hardware import MidiDevicesDialog
from .libdawnext.item_editor.audio import (
    AudioItemSeq,
    AudioItemSeqWidget,
)
from .libdawnext.item_editor.automation import (
    AutomationEditor,
    AutomationEditorWidget,
)
from .libdawnext.item_editor.editor import ItemListViewer
from .libdawnext.item_editor.notes import (
    PianoRollEditor,
...
from mkpy.libdawnext import strings as dn_strings
...
class MainWindow(QScrollArea):
    ...
    def tab_changed(self):
        ...
        if f_index == shared.TAB_SEQUENCER and not libmk.IS_PLAYING:
...
def init():
    ...
    shared.MIXER_WIDGET = mkplugins.MixerWidget(TRACK_COUNT_ALL)
    ...
    shared.ROUTING_GRAPH_WIDGET = pydaw_widgets.RoutingGraphWidget(
